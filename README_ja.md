...
nTimesは、Naverニュースから記事とコメントを収集し、ベクターデータベースに保存して、オントロジー（知識グラフ）を構築するシステムです。
...
コントリビューションを歓迎します！[Issue](https://github.com/hephaex/nTimes/issues)でバグレポートや機能提案をお願いします。
