...
///
/// ```
/// use ntimes::parser::sanitize::sanitize_text;
///
...
///
/// ```
/// use ntimes::parser::sanitize::remove_zero_width;
///
...
///
/// ```
/// use ntimes::parser::sanitize::remove_control_chars;
///
...
///
/// ```
/// use ntimes::parser::sanitize::decode_html_entities;
///
...
///
/// ```
/// use ntimes::parser::sanitize::normalize_whitespace;
///
...
///
/// ```
/// use ntimes::parser::sanitize::trim_lines;
///
/// let text = "  Line 1  \n  Line 2  ";
...
///
/// ```
/// use ntimes::parser::sanitize::collapse_newlines;
///
/// let text = "Para 1\n\n\n\n\nPara 2";
...
///
/// ```
/// use ntimes::parser::sanitize::strip_html_tags;
///
...
///
/// ```
/// use ntimes::parser::sanitize::has_content;
///
...
///
/// ```
/// use ntimes::parser::sanitize::truncate;
///
...
///
/// ```
/// use ntimes::parser::sanitize::remove_byline;
///
/// let text = "기사 내용입니다.\n홍길동 기자";
