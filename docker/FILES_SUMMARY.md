...
This document provides an overview of all Docker-related files created for the baram project.
...
# Weekly full backups
docker-compose exec postgres pg_dump -U baram -F c baram > backup_weekly.dump
