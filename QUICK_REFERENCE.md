# Quick Reference - baram Module Architecture
...
```rust
use baram::crawler::{ParsedArticle, NewsCategory};
...
```rust
use baram::crawler::{CrawlState, NewsCategory, CrawlStatus};
